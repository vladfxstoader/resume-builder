...
namespace IdentityMicroservice.Infrastructure.Services.Managers.Token
{
    public class TokenManager : ITokenManager
    {
        ...
        public TokenManager(IdentityDbContext context, RefreshTokenConfig refreshTokenConfig, SignInKeySetting signInKeySetting, LoginTokenConfig loginTokenConfig)
        {
            _context = context;
